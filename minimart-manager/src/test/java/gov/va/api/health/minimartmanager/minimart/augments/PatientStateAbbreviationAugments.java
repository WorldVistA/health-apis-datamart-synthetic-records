...
public class PatientStateAbbreviationAugments {
  ...
  static TreeMap<String, String> initStateAbbreviations() {
    var csvFile =
        PatientStateAbbreviationAugments.class.getResourceAsStream(
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartPatient.class)
        ...
        .transform(PatientStateAbbreviationAugments::addStateAbbreviations)
        .build()
        .rewriteFiles();
  }
