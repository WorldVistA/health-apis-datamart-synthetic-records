...
public class ImmunizationVaccineCodeGroupAugment {
  ...
  static Map<String, VaccineCodeRow> initVaccineCodes() {
    var csvFile =
        ImmunizationVaccineCodeGroupAugment.class.getResourceAsStream(
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartImmunization.class)
        ...
        .transform(ImmunizationVaccineCodeGroupAugment::switchVaccineCodeToArray)
        .build()
        .rewriteFiles();
  }
