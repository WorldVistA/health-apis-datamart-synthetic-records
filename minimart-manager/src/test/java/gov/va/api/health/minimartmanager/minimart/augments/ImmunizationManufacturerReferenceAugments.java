...
public class ImmunizationManufacturerReferenceAugments {
  ...
  static Map<String, String> initManufacturers() {
    var csvFile =
        ImmunizationManufacturerReferenceAugments.class.getResourceAsStream(
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartImmunization.class)
        ...
        .transform(ImmunizationManufacturerReferenceAugments::addManufacturerReferences)
        .build()
        .rewriteFiles();
  }
}
