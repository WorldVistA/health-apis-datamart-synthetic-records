...
public class LocationReferenceAugment {
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartImmunization.class)
        ...
        .transform(LocationReferenceAugment::addLocationToImmunization)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartProcedure.class)
        .whenMatching(Objects::nonNull)
        .transform(LocationReferenceAugment::addLocationToProcedure)
        .build()
        .rewriteFiles();
  }
}
