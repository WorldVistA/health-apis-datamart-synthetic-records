...
public class PractitionerReferenceSuffixAugment {
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartAllergyIntolerance.class)
        ...
        .transform(PractitionerReferenceSuffixAugment::addPractitionerIdSuffixToAllergyIntolerance)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartAppointment.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceSuffixAugment::addPractitionerIdSuffixToAppointment)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartCondition.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceSuffixAugment::addPractitionerIdSuffixToCondition)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartMedicationOrder.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceSuffixAugment::addPractitionerIdSuffixToMedicationOrder)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartObservation.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceSuffixAugment::addPractitionerIdSuffixToObservation)
        .build()
        .rewriteFiles();
  }
}
