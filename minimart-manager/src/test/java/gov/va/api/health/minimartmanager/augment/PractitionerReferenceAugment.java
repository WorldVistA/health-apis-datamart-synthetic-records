...
public class PractitionerReferenceAugment {
  ...
  public static void main(String[] args) {
    Augmentation.forResources(DatamartAllergyIntolerance.class)
        ...
        .transform(PractitionerReferenceAugment::addPractitionerToAllergyIntolerance)
        .build()
        .rewriteFiles();
    Augmentation.forResources(DatamartCondition.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceAugment::addPractitionerToCondition)
        .build()
        .rewriteFiles();
    // See ImmunizationPrescriberAugment
    // See ImmunizationRequesterAugment
    Augmentation.forResources(DatamartMedicationOrder.class)
        .whenMatching(Objects::nonNull)
        .transform(PractitionerReferenceAugment::addPractitionerToMedicationOrder)
        .build()
        .rewriteFiles();
    // See ObservationPerformerAugment
  }
}
