...
import gov.va.api.health.minimartmanager.transformers.F2DAllergyIntoleranceTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DConditionTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DDiagnosticReportTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DImmunizationTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DMedicationOrderTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DMedicationStatementTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DMedicationTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DObservationTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DPatientTransformer;
import gov.va.api.health.minimartmanager.transformers.F2DProcedureTransformer;
import java.io.File;
